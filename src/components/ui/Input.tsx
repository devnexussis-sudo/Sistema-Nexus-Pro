  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <input
          className={`w-full h-10 bg-white border border-slate-200 text-slate-900 rounded-xl focus:ring-4 focus:ring-primary-500/5 focus:border-primary-500/50 placeholder-slate-400 transition-all text-sm ${icon ? 'pl-10' : 'pl-3'} ${rightElement ? 'pr-10' : 'pr-3'} ${className}`}
          {...props}
        />
        {rightElement && (
