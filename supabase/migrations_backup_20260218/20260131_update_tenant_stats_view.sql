-- Migration: Update Tenant Statistics View with Enabled Modules
-- Description: View otimizada para estatísticas globais de empresas incluindo módulos habilitados
...
SELECT 
  ...
  t.os_prefix,
  t.os_start_number,
  t.enabled_modules, -- Adicionado para controle de planos
  t.created_at,
  t.updated_at,
  t.status,
